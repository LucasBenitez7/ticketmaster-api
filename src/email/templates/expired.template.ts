...
export function expiredTemplate(
  p: Extract<EmailPayload, { type: 'expired' }>,
): string {
  return baseLayout(`
    <h2 style="margin:0 0 8px;font-size:22px;color:#111827">Tu reserva expiró ⏰</h2>
    <p style="margin:0 0 24px;color:#6b7280">Hola ${p.userName}, tu reserva para el siguiente evento no fue completada a tiempo.</p>
    ...
    <p style="margin:0;color:#6b7280;font-size:14px">El stock ha sido liberado. Si aún deseas asistir, puedes intentar la compra nuevamente.</p>
  `);
}
